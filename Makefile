...
O_DIR=obj
CXX=g++
cpp_dirs=math game-state ui animation settings entity entity/player
external_files=
SRC=src
...
CXX_FLAGS=$(addprefix -I, $(H_FILES)) `sdl2-config --libs --cflags` -O3 -Wall -lSDL2_image -lm -std=c++17 -lSDL2_ttf -lutil -lSDL2_image
